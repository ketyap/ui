...
import {
  ...
  RenderSpan,
  RenderAnchor,
} from "@/components/ui/render-element";
...
const SidebarGroupLabel = ({
  ...
  render,
  ...props
}: React.ComponentProps<"div"> & { render?: useRender.RenderProp<object> }) => {
  const Comp = RenderDiv;
...
const SidebarGroupAction = ({
  ...
  const Comp = render ? RenderSpan : BaseButton;
