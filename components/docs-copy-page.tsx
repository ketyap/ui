...
export const DocsCopyPage = ({
  ...
  const trigger = (
    <Button
      variant="secondary"
      size="sm"
      className="peer size-8 rounded-l-none md:size-7 md:text-[0.8rem]"
    >
  ...
  return (
    <Popover sounds>
      <div className="group/buttons relative flex *:focus-visible:z-10">
        <CopyButton
          value={copyValue}
          showTooltip={false}
          sound="copy"
          variant="secondary"
          className="rounded-r-none md:h-7 md:text-[0.8rem]"
        >
          Copy Page
        </CopyButton>
        <DropdownMenu sounds>
        ...
        <Separator
          ...
          className="pointer-events-none absolute top-1 right-8 z-0 h-6! bg-foreground/5! peer-focus-visible:opacity-0 md:right-7 md:h-5!"
        />
